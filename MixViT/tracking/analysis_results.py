...
from MixViT.lib.test.analysis.plot_results import plot_results, print_results, print_per_sequence_results
from MixViT.lib.test.evaluation import get_dataset, trackerlist
import argparse
...
parser.add_argument('--run_ids', type=str, help='Name of config file.', default=None)
# parser.add_argument('--run_ids', nargs='+', help='<Required> Set flag', required=True)
args = parser.parse_args()

dataset_name = args.dataset_name

trackers.extend(trackerlist(name='mixformerpp_vit_online', parameter_name=args.tracker_param, dataset_name=args.dataset_name,
                            run_ids=args.run_ids, display_name='MixFormerViTOnline'))
"""TransT"""
