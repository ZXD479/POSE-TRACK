...
class SoccerNet(BaseVideoDataset):
    """ SoccerNet dataset.
    """
    def __init__(self, root=None, annotations=None, image_loader=jpeg4py_loader, split='train', data_fraction=None):
        """
        args:
            root        - The path to the SoccerNet folder, containing the train, val, test sets.
        ...
        super().__init__('SoccerNet', root, image_loader)
    ...
    def _get_frame(self, seq_id, frame_id):
        seq_name=self.sequence_list[seq_id][:9]
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        object_meta = OrderedDict({'object_class_name': 'player',
                                   'seq':self.sequence_list[seq_id][:9],
                                   'id':self.sequence_list[seq_id][10:],
                                   'frames':frame_ids,})
