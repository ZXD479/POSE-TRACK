...
train_json = json.load(open('/data2/zxd/sportsmot_publish/dataset/annotations/train.json','r'))
...
val_json = json.load(open('/data2/zxd/sportsmot_publish/dataset/annotations/val.json','r'))
img_id_count = 0
...
json.dump(mix_json, open('/data2/zxd/sportsmot_publish/dataset/annotations/mix.json','w'))