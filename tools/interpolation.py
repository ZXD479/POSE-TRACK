...
if __name__ == '__main__':
    #data_root = '/data2/zxd/sportsmot_publish/dataset/test/'
    txt_path = 'parameter/0.7_0.3_second_unconfirm'
    save_path = 'parameter/0.7_0.3_second_unconfirm_dti'
    
    for filename in os.listdir(txt_path):
    # 检查文件名是否以 "ped" 开头
        if filename.startswith('ped'):
            # 构建文件的完整路径
