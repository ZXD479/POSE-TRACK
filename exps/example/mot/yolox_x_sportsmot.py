...
class Exp(MyExp):
    ...
    def get_eval_loader(self, batch_size, is_distributed, testdev=False, return_origin_img=False):
        ...
        return val_loader
    def get_eval1_loader(self, batch_size, is_distributed, testdev=False, return_origin_img=False):
        from yolox.data import MOTDataset, ValTransform
        ...
        valdataset = MOTDataset(
            ...
            json_file=self.val_ann,
            img_size=self.test_size,
            name='val1', # change to train when running on training set
            preproc=ValTransform(
                rgb_means=(0.485, 0.456, 0.406),
                std=(0.229, 0.224, 0.225),
            ),
    ...
    def get_evaluator(self, batch_size, is_distributed, testdev=False):
        ...
        return evaluator
    def get_test_loader(self, batch_size, is_distributed, testdev=False, return_origin_img=False):
        from yolox.data import MOTDataset, ValTransform
