...
from MixViT.lib.config.mixformerpp_vit_multi.config import cfg, update_config_from_file
...
def parameters(yaml_name: str, model=None, search_area_scale=None):
    ...
    yaml_file = os.path.join(prj_dir, 'experiments/mixformerpp_vit_multi/{}.yaml'.format(yaml_name))
