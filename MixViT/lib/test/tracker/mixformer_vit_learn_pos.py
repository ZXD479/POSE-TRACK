...
import cv2
import os
from MixViT.lib.utils.merge import merge_template_search
from MixViT.lib.models.mixformer_vit import build_mixformer_vit_learn_pos
...
class MixFormer(BaseTracker):
    def __init__(self, params, dataset_name):
        ...
        network = build_mixformer_vit_learn_pos(params.cfg)
    ...
    def track(self, image, info: dict = None):
        ...
        with torch.no_grad():
            out_dict, _ = self.network(self.template, None, search)
