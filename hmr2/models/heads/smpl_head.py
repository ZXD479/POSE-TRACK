...
class SMPLTransformerDecoderHead(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        #transformer_args = (transformer_args | dict(cfg.MODEL.SMPL_HEAD.TRANSFORMER_DECODER))#标记
        transformer_args = transformer_args.copy()  # 创建 transformer_args 的副本
        transformer_args.update(cfg.MODEL.SMPL_HEAD.TRANSFORMER_DECODER)
