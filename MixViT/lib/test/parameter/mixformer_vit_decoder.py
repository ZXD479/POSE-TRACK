...
from MixViT.lib.config.mixformer_vit_decoder.config import cfg, update_config_from_file
...
def parameters(yaml_name: str, model=None, search_area_scale=None):
    ...
    yaml_file = os.path.join(prj_dir, 'experiments/mixformer_vit_decoder/%s.yaml' % yaml_name)
